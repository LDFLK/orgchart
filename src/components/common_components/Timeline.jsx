    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg w-full mt-6">
            ...
            <div className="flex gap-2 mb-6 flex-wrap sm:justify-start justify-center">
                ...
                {[
                    ...
                    <button
                        ...
                        className={`px-2 text-sm font-medium rounded-lg transition-colors ${activePreset === preset.label
            ...
            >
                ...
                <div ref={containerRef} className="relative bg-gray-50 dark:bg-gray-700 mb-6" style={{ height: "55px", minWidth: `${years.length * 80}px` }}>
                    ...
                    {/* Drag handles */}
                    <div className="absolute top-7 transform -translate-y-1/2 -translate-x-1/2 w-4 h-6 bg-blue-600 rounded cursor-ew-resize flex items-center justify-center shadow hover:bg-blue-700 z-20" style={{ left: handlePositions.startLeft }} onMouseDown={e => handleMouseDown(e, "start")}><DragIndicatorIcon className="w-4 h-6 text-white" /></div>
                    <div className="absolute top-7 transform -translate-y-1/2 -translate-x-1/2 w-4 h-6 bg-blue-600 rounded cursor-ew-resize flex items-center justify-center shadow hover:bg-blue-700 z-20" style={{ left: handlePositions.endLeft }} onMouseDown={e => handleMouseDown(e, "end")}><DragIndicatorIcon className="w-4 h-6 text-white" /></div>
                    {/* Tooltip */}
                    {/* {tooltip.show && (
                        <div
