...
import { Typography, Paper, Avatar, Box, Button, Tabs, Tab } from '@mui/material';
...
/* ------------------- Timeline Component ------------------- */
const PersonHistoryTimeline = ({ selectedPerson, onTimelineUpdate }) => {
...
const PersonProfile = ({ selectedPerson }) => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, p: 6, backgroundColor: colors.backgroundPrimary, mt: -5 }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 1, flex: 1 }}>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                            <Typography sx={{ display: "flex", alignItems: "center", gap: 1, fontFamily: "Poppins", fontWeight: 500, color: colors.textMuted }}>
                                <ApartmentIcon sx={{ fontSize: 18, color: colors.textMuted }} />
                                Worked Ministries
                            </Typography>
            ...
            {activeTab === "history" && (
                <Box sx={{ mt: 2 }}>
                    <PersonHistoryTimeline selectedPerson={selectedPerson} onTimelineUpdate={setTimelineData} />
                </Box>
            )}
