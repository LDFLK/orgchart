...
export default function StatisticTimeline({ startYear, onDateChange }) {
    ...
    const [startDate, setStartDate] = useState(new Date(Date.UTC(startYear, 0, 1)));
    ...
    const overlayMetrics = React.useMemo(() => getPreciseOverlayMetrics(), [startDate, endDate]);
    const handlePositions = React.useMemo(() => getHandlePositions(), [startDate, endDate]);
    ...
    return (
		<div className="bg-gray-900/60 p-6 rounded-2xl w-full mt-6 border border-gray-800/60 text-gray-200">
            ...
            >
                ...
                <div ref={containerRef} className="relative bg-gray-50 dark:bg-gray-700 mb-6" style={{ height: "30px", minWidth: `${years.length * 80}px` }}>
